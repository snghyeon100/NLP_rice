"""End-to-end NPO unlearning runner.
...
from unlearning_methods.unlearn_npo.dataloader import NPOForgetDataset, npo_collator
from unlearning_methods.unlearn_npo.loss import compute_npo_loss
...
class NPOTrainer(Trainer):
    def __init__(self, *args, oracle_model=None, eval_cfg=None, tokenizer=None, beta=1.0, gamma=1.0, alpha=1.0, **kwargs):
        ...
        if self.oracle_model is None:
            raise ValueError("NPOTrainer requires an oracle/reference model.")
